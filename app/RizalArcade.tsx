    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><button className="button button-primary" type="button" onClick={() => launchGame("values")}>Start playing <span>▶</span></button><span>8 games · Student sign-in · Global Sojourn guest preview</span></div>
          <div className="hero-proof"><span><strong>8</strong> playable games</span><span><strong>2–5</strong> minute rounds</span><span><strong>400</strong> sourced challenges</span></div>
        </div>
