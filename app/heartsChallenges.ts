...
export const heartsChallenges: HeartsChallenge[] = [
  challenge("H01", "segunda", "A first affection", ["Rizal was still very young.", "She belonged to a prominent family from Lipa.", "Their brief affection could not become a lasting courtship."], "Segunda Katigbak is commonly presented in the course module as Rizal’s first love."),
  ...
  challenge("H03", "segunda", "A youthful memory", ["This chapter belongs before Rizal’s European years.", "It is associated with Lipa and visits in Manila.", "Later accounts remember it as an early, short-lived affection."], "The Lipa-and-Manila setting and the youthful timing point to Segunda Katigbak."),
  challenge("H04", "segunda", "The earliest horizon", ["Not Madrid, London, Brussels, or Dapitan.", "A young Rizal encountered her in the Philippines.", "Her family background and engagement limited the relationship."], "Segunda belongs to the earliest Philippine chapter in the game’s relationship trail."),
  challenge("H05", "segunda", "The Lipa clue", ["Her hometown is the strongest route clue.", "The episode is remembered as brief.", "It came before the long correspondence with another Leonor."], "Lipa and the brief first-love tradition identify Segunda Katigbak."),

  challenge("H06", "valenzuela", "Invisible ink", ["Letters carried the courtship.", "The writing could be revealed by applying heat.", "This was a Manila student-years chapter."], "The invisible-ink correspondence is the signature clue associated with Leonor Valenzuela."),
  challenge("H07", "valenzuela", "Orang’s letters", ["She was also known by the nickname Orang.", "Rizal used a secret method in his letters.", "Her chapter is distinct from Leonor Rivera’s long engagement."], "The nickname Orang and the secret letters point to Leonor Valenzuela, not Leonor Rivera."),
  ...
  challenge("H09", "valenzuela", "A second Leonor", ["Her first name can cause confusion with Rizal’s long-time fiancée.", "Her distinguishing clue is invisible ink.", "The relationship belongs to the Manila period."], "Leonor Valenzuela is identified by the invisible-ink clue; Leonor Rivera is identified by the long, interrupted correspondence."),
  ...
  challenge("H14", "rivera", "Camiling route", ["Her family is associated with Camiling, Tarlac.", "She and Rizal were relatives as well as sweethearts.", "Their story spans Rizal’s years in Europe."], "Camiling and the years-long European correspondence identify Leonor Rivera."),
  ...
  challenge("H17", "rivera", "Not the invisible-ink Leonor", ["This woman shares a first name with Orang.", "Her identifying clue is the length of the relationship.", "A farewell composition and engagement belong to her dossier."], "The engagement and farewell verse identify Leonor Rivera; invisible ink identifies Leonor Valenzuela.", leonorSource),

  challenge("H18", "consuelo", "The Madrid circle", ["This chapter unfolds in Spain.", "Her family welcomed Filipino reformists and students.", "Rizal expressed admiration but did not pursue a lasting relationship."], "Consuelo Ortiga y Pérez belongs to Rizal’s Madrid social circle."),
  challenge("H19", "consuelo", "A friendship in Spain", ["The place stamp reads Madrid.", "She was the daughter of Don Pablo Ortiga y Rey.", "The connection remained part of Rizal’s European social life."], "Madrid and the Ortiga household identify Consuelo Ortiga y Pérez."),
  ...
  challenge("H21", "consuelo", "Ortiga salon", ["Filipino expatriates gathered at her family home.", "The setting is the Spanish capital.", "This was not the London boarding-house chapter."], "The Ortiga home in Madrid provides the decisive context for Consuelo."),
  challenge("H22", "consuelo", "Madrid admiration", ["This relationship belongs after Rizal left the Philippines for study.", "The woman was Spanish.", "Its horizon is Madrid rather than Biarritz."], "Consuelo Ortiga y Pérez represents a Madrid admiration, while Nellie Boustead belongs to the Biarritz chapter."),

  challenge("H23", "seiko", "O-Sei-San", ["Her nickname appears in Rizal histories.", "She spoke with Rizal in French during afternoon strolls.", "She introduced him to aspects of Japanese culture."], "O-Sei-San was Seiko Usui, whom Rizal met during his 1888 stay in Japan.", seikoSource),
  challenge("H24", "seiko", "Six weeks in Japan", ["The meeting took place during Rizal’s journey in 1888.", "The Japanese chapter lasted for approximately six weeks.", "The route postmark for this dossier is Yokohama."], "UP’s account places Rizal and Seiko Usui’s friendship within his roughly six-week Japanese sojourn in 1888.", seikoSource),
  ...
  challenge("H26", "seiko", "A Japanese horizon", ["This person was not part of Rizal’s European boarding-house circle.", "She helped him encounter local art and culture.", "The journey continued when Rizal left Yokohama."], "The Japanese cultural setting distinguishes Seiko Usui’s chapter.", seikoSource),
  challenge("H27", "seiko", "Yokohama dossier", ["The route code is YK.", "The short relationship occurred between larger journeys.", "She is remembered by both a personal name and an honorific nickname."], "Yokohama and the name O-Sei-San resolve the dossier as Seiko Usui.", seikoSource),

  challenge("H28", "gertrude", "The Beckett household", ["Rizal lodged with her family.", "The city was London.", "She assisted him while he worked on art and research."], "Gertrude Beckett was a daughter of Rizal’s London landlord and belongs to his London chapter."),
  challenge("H29", "gertrude", "London affection", ["This dossier is set in England.", "Her family name matches Rizal’s hosts.", "Rizal eventually left for continental Europe."], "The London setting and Beckett household identify Gertrude Beckett."),
  ...
  challenge("H31", "gertrude", "English route", ["Not Madrid and not Brussels.", "Rizal was studying Philippine history in the British Museum period.", "The family surname is Beckett."], "The British Museum period and Beckett name point to Gertrude in London."),
  challenge("H32", "gertrude", "A goodbye from London", ["Her affection is associated with Rizal’s lodging.", "He did not remain in England.", "This relationship is usually described as unfulfilled."], "Gertrude Beckett represents an unfulfilled London affection in the course module."),
  ...
  challenge("H34", "nellie", "Biarritz chapter", ["The route stamp points to the French coast.", "Rizal spent time with the Boustead family.", "A proposal was considered but not completed."], "Biarritz and the possibility of marriage identify Nellie Boustead."),
  ...
  challenge("H36", "nellie", "The Boustead family", ["Her surname names the family hosting Rizal in France.", "She was intelligent and athletic in course accounts.", "The relationship followed the end of Rizal’s hopes with Leonor Rivera."], "The Boustead family and the serious French courtship identify Nellie."),
  challenge("H37", "nellie", "A respectful ending", ["The relationship was more serious than a passing admiration.", "Marriage was discussed.", "They separated without the long correspondence associated with Leonor Rivera."], "Nellie’s dossier centers on a possible marriage that did not proceed."),

  challenge("H38", "suzanne", "The Brussels boarding house", ["Rizal rented a room from her family.", "The setting was Belgium.", "She became attached to him during his stay."], "Suzanne Jacoby belongs to Rizal’s Brussels boarding-house chapter."),
  challenge("H39", "suzanne", "Belgian horizon", ["The route stamp reads Brussels.", "The connection developed under the same roof.", "Rizal later departed to continue his work and travels."], "The Brussels setting and Rizal’s stay in the Jacoby household identify this dossier with Suzanne Jacoby."),
  ...
  challenge("H41", "suzanne", "Rue Philippe", ["The clue is a Brussels address.", "Rizal was writing and working in Belgium.", "The relationship did not become an engagement."], "The Brussels residence places this dossier with Suzanne Jacoby."),
  ...
  challenge("H43", "josephine", "The Dapitan companion", ["She arrived with her blind stepfather, who sought treatment.", "The relationship developed during Rizal’s exile.", "She shared his household in his final years."], "Josephine Bracken met Rizal in Dapitan and became his companion during the last chapter of his life.", josephineSource),
  challenge("H44", "josephine", "A patient’s daughter", ["The journey began with a medical consultation.", "Her stepfather was George Taufer.", "The route stamp is Dapitan."], "George Taufer’s visit for eye treatment brought Josephine Bracken to Rizal in Dapitan.", josephineSource),
  challenge("H45", "josephine", "Final love", ["The National Museum uses this phrase for her place in Rizal’s life.", "Rizal sculpted her resting figure in Dapitan.", "The work is known as Josephine Sleeping."], "The National Museum identifies Josephine Bracken as Rizal’s final love and preserves the context of his Dapitan sculpture.", museumSource),
  challenge("H46", "josephine", "After Dapitan", ["She was present near the end of Rizal’s life.", "After his death, she joined revolutionary forces.", "Accounts describe her helping wounded fighters."], "Josephine’s later involvement with revolutionaries and care for the wounded extends her story beyond Dapitan.", josephineSource),
  challenge("H47", "josephine", "A shared Dapitan life", ["This chapter includes domestic life during exile.", "The couple experienced the loss of an infant son.", "Their union faced religious and legal obstacles."], "The Dapitan household and the couple’s personal loss identify Josephine Bracken."),
  ...
  challenge("H49", "josephine", "From Hong Kong to Dapitan", ["She had been raised in Hong Kong.", "A journey for medical help brought her to Mindanao.", "She became Rizal’s partner in exile."], "Josephine’s Hong Kong background and Dapitan arrival distinguish her from Rizal’s European acquaintances.", josephineSource),
